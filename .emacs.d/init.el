...
(global-set-key (kbd "C-;") 'org-latex-preview-all-sections)
...
;; Enable word wrapping with indentation
...
(global-set-key (kbd "C-a") 'my/open-org-file)
(define-key global-map (kbd "C-o") nil)
(global-set-key (kbd "C-o") 'my/open-org-file)


(defun surround-latex (&optional arg)
   (interactive "P")
   (insert-pair arg ?\$ ?\$))

(global-set-key (kbd "C-k") 'surround-latex)

(add-hook 'org-mode-hook 'org-fragtog-mode)
;;(add-to-list 'org-latex-packages-alist '("" "my-org-preview.sty" t ))
